...
export function renderNginx(stack) {
  const lines = [
    "# Phase 2 preview config",
    "# HTTP routing only for local validation.",
    "# TLS/certificate directives are intentionally deferred to later phases and final cutover validation.",
    "",
